...
const FOREST_REGEN_IDENTITY_OVERRIDES: Record<string, Partial<IdentityProfile>> = {
  ...
  'forest-13': {
    ...
    jawShape: 'soft-tapered',
    chinShape: 'medium-rounded',
    skinTone: 'fair-warm',
    eyeShape: 'slightly upturned',
    eyeSpacing: 'slightly-close',
    browShape: 'soft angled',
    noseShape: 'slender bridge',
    noseWidth: 'slender-medium',
    lipShape: 'narrow defined',
    lipRatio: 'both-slim',
    asymmetry: 'slightly higher left brow',
    distinctiveFeature: 'tiny beauty mark near the right cheekbone',
  ...
  'forest-15': {
    ...
    jawShape: 'broad-soft',
    chinShape: 'broad-soft',
    skinTone: 'golden-beige',
    eyeShape: 'monolid',
    eyeSpacing: 'balanced',
    browShape: 'thick straight',
    noseShape: 'wider natural bridge',
    noseWidth: 'wide-natural',
    lipShape: 'broad balanced',
    lipRatio: 'wide-medium',
    asymmetry: 'soft jaw asymmetry',
    distinctiveFeature: 'soft cheek dimples',
  ...
  'forest-17': {
    ...
    eyeShape: 'rounded monolid',
    eyeSpacing: 'slightly-wide',
    browShape: 'straight-soft',
    noseShape: 'short refined',
    noseWidth: 'balanced',
    lipShape: 'small rounded',
    lipRatio: 'small-full',
    asymmetry: 'minor eye-height asymmetry',
    distinctiveFeature: 'clean face with no visible marks',
  ...
  'forest-20': {
    ...
    skinTone: 'warm-beige',
    eyeShape: 'soft downturned',
    eyeSpacing: 'wide',
    browShape: 'fine curved',
    noseShape: 'gentle convex bridge',
    noseWidth: 'narrow-tip',
    lipShape: 'slender upper lip',
    lipRatio: 'upper-thin/lower-full',
    asymmetry: 'slightly higher right brow',
    distinctiveFeature: 'slight natural smile asymmetry',
    hair: ['shoulder-length', 'center-parted', 'black']
  }
};
